    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Rental Rooms - Administrator Panel</a>
            </div>
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active"><a href="index.php"> &nbsp; &nbsp; &nbsp; Home</a></li>
					<li><a data-toggle="modal" data-target="#uploadModal"> &nbsp; &nbsp; &nbsp; Upload Rooms</a></li>
                    
                	<li><a data-toggle="modal" data-target="#uploadModaltwo"> &nbsp; &nbsp; &nbsp; Upload Other Services</a></li>    
                    
					<li><a href="items.php"> &nbsp; &nbsp; &nbsp; Rooms Management</a></li>
...
We concluded that people leaving homes to relocate to another city needed more than just a house. They needed a place they could call home, a community where they would be accepted and a platform which allows connections to various other access points.
			...
			<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy 2020 Rental Rooms| All Rights Reserved |  Design by : Rental Rooms Team
          ...
          <div class="modal-dialog modal-md">
            <div style="color:white;background-color:#008CBA" class="modal-content">
              <div class="modal-header">
                ...
                <h2 style="color:white" class="modal-title" id="myModalLabel">Upload Rooms</h2>
              </div>
	...
	<!-- Mediul Modal two -->
        <div class="modal fade" id="uploadModaltwo" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-md">
            <div style="color:white;background-color:#008CBA" class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h2 style="color:white" class="modal-title" id="myModalLabel">Upload Services</h2>
              </div>
              <div class="modal-body">
			
				
				 <form enctype="multipart/form-data" method="post" action="service_other.php">
                   <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Name of Service" name="item_name" type="text" required>
